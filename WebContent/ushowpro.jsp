							...
							<div class="flex-w flex-r-m p-b-10">
								...
								<div class="size-204 respon6-next">
									...
									<button class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04" >
										<a style="color:white" href="ucart.jsp?name=<%=name%>&price=<%=price%>&image=<%=image%>">ADD TO CART</a>
									</button>
									<button class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04"  >
										<a href="uwishlist.jsp?name=<%=name%>&price=<%=price%>&image=<%=image%>" style="text-decoration: none;color:white" >Add to Wishlist</a>
									</button>
